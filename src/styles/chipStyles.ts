/** Shared chip/toggle button styles for role and hero selection across the app */
export const chipBase =
  'px-3 py-1.5 rounded-lg text-xs font-bold uppercase transition-all duration-200 disabled:opacity-50';
